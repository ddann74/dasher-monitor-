    ...
    public void onNotificationPosted(StatusBarNotification sbn) {
        ...
        try {
            ...
            if (isPersonalMessagingApp) {
                // Messenger posts these as its own system/status notifications,
                // not as a message from a person -- filtered out before the
                // sender-name extraction/trusted-sender lookup below, so they
                // never get read aloud regardless of what's on the trusted list.
